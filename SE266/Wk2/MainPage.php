...
<head>
    ...
    <title>PHP & MySQL | Main Course Page</title>
...
<body style="background-color: #161b22; color: white">
    ...
    <div style="margin-right: 2%; margin-left: 2%;">
        <h1><b>PHP & MySQL - Axel Fernandes-Spencer</b></h1>
        This is an overview page on all my PHP projects
        
        <h2>Assignments</h2>

        <ul>
            <li><a href="../Wk1/MTG.php">Wk1 - FizzBuzz</a></li>
            <li><a href="">Wk2 - Patient</a></li>
            <li><a href="">Wk3 - ATM</a></li>
            <li><a href="">Wk4 - Patients</a></li>
            <li><a href="">Wk5 - Patient CRUD</a></li>
            <li><a href="">Wk6 - Patient Metrics</a></li>
